            ...
            <div class="flex flex-col justify-between gap-[12px] max-w-[410px] md:w-2/5">
                <div>
                    ...
                    <div class="loginDetail">
                        <div class="my-[20px]">Get early access to the Political Ad Dashboard! Limited spots available—sign up now to secure your place and be among the first to explore our powerful new tool. Don't miss out!</div>
                    </div>
                </div>
                <div class="loginDetail">
